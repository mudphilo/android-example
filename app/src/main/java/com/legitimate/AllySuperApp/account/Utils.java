...
public class Utils {
    ...
    public static final String TOKEN_TYPE = "com.legitimate.AllySuperApp.token";
    public static final String ACCOUNT_TYPE = "com.legitimate.AllySuperApp.account";
    public static final String SYNC_AUTHORITY = "com.android.contacts";
    public static final String IM_PROTOCOL = "Ally";
    ...
    public static SparseArray<ContactHolder> fetchEmailsAndPhones(ContentResolver resolver, Uri uri,String country) {
        ...
        // ok, let's work...
        Cursor cursor = resolver.query(uri, projection, selection, selectionArgs, "mimetype ASC");
        if (cursor == null) {
            return map;
        }
        ...
        final int displayNameIdx = cursor.getColumnIndex(ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME_PRIMARY);


        final PhoneNumberUtil phoneUtil = PhoneNumberUtil.getInstance();
        //String country = Utils.getCountry(context);//Locale.getDefault().getCountry();
